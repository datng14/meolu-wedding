...
const TimeUnit = ({ value }: { value: number; label: string }) => (
  <motion.div className='flex flex-col items-center' variants={numberVariants}>
    <motion.div
      key={value}
      className='text-3xl md:text-4xl lg:text-5xl font-semibold mb-1 font-dancing-script'
...
export default function Countdown() {
  ...
  return (
    ...
    >
      ...
      >
        <motion.h2
          className='text-xl lg:text-2xl mb-8 md:mb-12 leading-relaxed font-heading'
          style={{ color: 'var(--theme-primary)' }}
